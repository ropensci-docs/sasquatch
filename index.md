...
![](reference/figures/run_sas_selected.gif)
...
Pass tables between R and SAS with
...
in the same style you would expect from SAS with the
[`sas_engine()`](https://docs.ropensci.org/sasquatch/reference/sas_engine.md).

![](reference/figures/rendered_quarto.png)
